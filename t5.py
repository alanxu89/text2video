...
class T5Embedder:
    ...
    def __init__(
        ...
        self.model = T5EncoderModel.from_pretrained(from_pretrained).eval().to(
            self.device)
    ...
    def get_text_embeddings(self, texts):
        ...
        # for key, val in text_tokens_and_mask.items():
        #     print(key, val.shape)
        #     print(val)
        ...
        return text_encoder_embs, text_tokens_and_mask["attention_mask"].to(
            self.device)
...
if __name__ == "__main__":
    enc = T5Encoder(from_pretrained="DeepFloyd/t5-v1_1-xxl")
